...
// var errorMessageName = document.createElement('p');
// errorMessageName.textContent = "Name can not be empty"
...
buttonSubmit.addEventListener('click',  function(event) {
	...
	// console.log("This is name ", name.value, name);
	// if (name.value.length < 1) {
	// 	var errorMessageName = document.createElement('p');
	// 	errorMessageName.textContent = "Name can not be empty"
	// 	errorMessageName.style.color = "red"
	// 	var parent = document.getElementById("form-name-error");
	// 	parent.appendChild(errorMessageName);
	// }
